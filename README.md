...
* ~~[CANCELED][refacto] définir un type pour les fichier json: le code de manipulation du fichier composer.json n'est pas basé sur une définition de type pour ce fichier;~~  
